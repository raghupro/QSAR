...
def log(logType, logData):
    if logType == 'error':
        fileName = os.path.join(logFolderPath(), 'ErrorLog.txt')
        nameHandle = open(fileName, 'a')
        nameHandle.write(str(datetime.now())+'\n'+logData+'\n\n')
        nameHandle.close()
    if logType == 'process':
        fileName = os.path.join(logFolderPath(), 'ProcessLog.txt')
        nameHandle = open(fileName, 'a')
        nameHandle.write(str(datetime.now())+'\n'+logData+'\n\n')
        nameHandle.close()
    if logType == 'retrain':
        fileName = os.path.join(logFolderPath(), 'RetrainLog.txt')
        nameHandle = open(fileName, 'a')
